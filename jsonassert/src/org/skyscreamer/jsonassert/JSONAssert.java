...
public class JSONAssert {
    ...
    public static void assertEquals(String expectedStr, String actualStr, boolean strict, String maskWord, String splitChars)
            throws JSONException {
        assertEquals(expectedStr, actualStr, strict ? JSONCompareMode.STRICT : JSONCompareMode.LENIENT, maskWord, splitChars);
    }
    
    
    public static void assertEquals(String expectedStr, String actualStr, JSONCompareMode compareMode,String maskWord, String splitChars)
            throws JSONException {
        JSONCompareResult result = JSONCompare.compareJSON(expectedStr, actualStr, compareMode,maskWord, splitChars);
        if (result.failed()) {
